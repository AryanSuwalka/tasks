  ...
  return (
    <section className="bg-white dark:bg-gray-900 py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white text-center">Our Pricing</h2>
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 bg-gray-50 dark:bg-gray-800">
            ...
            <button className="mt-6 w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600">Choose Plan</button>
          </div>
